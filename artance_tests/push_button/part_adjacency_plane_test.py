...
DEFAULT_POINTCLOUD_NPZ = (
    ...
    / "outputs/pointcloud/variation0_episode2_frame036_wrist/36/36_camera_sam3_parts.npz"
)
DEFAULT_SOURCE_SUMMARY = (
    Path(__file__).resolve().parent
    / "outputs/pointcloud/variation0_episode2_frame036_wrist/36/pointcloud_summary.json"
)
...
def parse_args() -> PartAdjacencyPlaneConfig:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "estimate the push normal, and save JSON plus PLY visualization."
        )
    )
